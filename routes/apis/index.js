...
const chatController = require('../../controllers/apis/chat-controller')
const upload = require('../../middleware/multer')
const { authenticated } = require('../../middleware/auth')
const { apiErrorHandler } = require('../../middleware/error-handler')

router.get('/users/checkAccount/:account', userController.checkAccount)
router.get('/users/chatroom/public/initialization', chatController.getAllMessages)
router.get('/users/chatroom/private/:senderId', chatController.getPrivateMessages)
